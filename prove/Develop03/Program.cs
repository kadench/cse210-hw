...
class Journal
{
    ...
    {   
        ...
        // Read the file path from before so that it can be out of the while loop (not sure if this works)
        string khFilePathFromWhile = Console.ReadLine();

        // Create a new string list.
        List<string> khFileLines = new List<string>();

        // Add every line from the file to the new string list.
        using (StreamReader reader = new StreamReader(khFilePathFromWhile))
        {
